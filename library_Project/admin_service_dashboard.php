...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><h1>Library Management System</h1></div><br>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="physics"/>physics<input type="radio" name="branch" value="Biology"/>Biology<div style="margin-left:80px"><input type="radio" name="branch" value="computer"/>computer<input type="radio" name="branch" value="sociology"/>sociology</div>
            </div>   
